...
make_group(group1_v, add_i2rm_v,
	inv, inv, inv, inv,
	sub_i2rm_v, inv, cmp_i2rm_v)

/* 0x83 */
make_group(group1_sx_v, add_si2rm_v, inv, inv,
	inv, add_si2rm_v,sub_si2rm_v, inv,
           cmp_si2rm_v)
...
/* 0x20 */	inv, and_r2rm_v, and_r2rm_b, inv,
...
/* 0x7c */	jl_i_b, jge_i_b, jle_i_b, jg_i_b,// TODO 不懂为啥_v错了
...
/* 0xa4 */	inv, movs_n_v, inv, inv,// TODO 报错只好替换掉了
...
/* 0x8c */	jl_i_v, inv, jle_i_v, inv, //TODO 为啥是2字节的指令
